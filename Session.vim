...
badd +37 Session.vim
badd +94 src/main/scala/com/tewe/nrftw/EnchantmentsBuilder.scala
...
badd +29 src/main/scala/com/tewe/nrftw/EnchantmentsBuilder.css
...
silent! normal! zE
let &fdl = &fdl
let s:l = 94 - ((17 * winheight(0) + 21) / 43)
