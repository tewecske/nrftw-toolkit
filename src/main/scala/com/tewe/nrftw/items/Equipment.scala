...
val helmetEnchants = List(
  ...
  Enchant("w_iwd", Weight, "Item Weight decreased by 7%-10%"),
...
val armorEnchants = List(
  ...
  Enchant("d_dtdb", Defense, "Damage Taken decreased by 25%-50% for 10 seconds after being afflicted by Status"),
