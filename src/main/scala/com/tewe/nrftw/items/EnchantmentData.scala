...
// format: off
  ...
  case class Enchantment(
    ...
    val (p0, p1) = effect match
      ...
      case ResourceLoss(resource, value, condition) => (EffectValue.extractValue(value), "")
      case ChanceEffect(chance, effect) => ("", "")
      case _ => ("", "")
    
    val value = s"""<div class="enchant-display-text">$rawText</span>"""
    val finalValue = value
      .replaceFirst("""\[(Stat\w+)\]""", s"""<div class="ui-font-icons icon-$$1"></div>""")
      .replaceFirst("""\{0\}""", s"""$p0""")
      .replaceFirst("""\{1\}""", s"""$p1""")
      .replaceFirst("""\[!(\w+)\]([\w ]+)\[/s\]""", s"""<span class="enchant-tag-$$1">$$2</span>""")
  ...
  val armorDecreased = Enchantment("down_ad", EnchantGroup.Downside, "enchantment.armorDecreased",
    ...
    StatModifier(StatType.Armor, ValueRange(20, 30, ValueType.Percentage), ModificationType.Decrease)
  )
  
  val armorIncreased = Enchantment("d_ai", EnchantGroup.Defense, "enchantment.armorIncreased",
    "[StatArmor] <b>Armor</b> increased by {0}",
    StatModifier(StatType.Armor, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val attackDamageDecreased = Enchantment("", EnchantGroup.Other, "enchantment.attackDamageDecreased",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val attackDamageIncreased = Enchantment("", EnchantGroup.Other, "enchantment.attackDamageIncreased",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val attackDamageIncreasedAfterRuneAttack = Enchantment("a_adiara", EnchantGroup.Attack, "enchantment.attackDamageIncreasedAfterRuneAttack",
    ...
    StatModifier(StatType.Damage, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.RuneAttack), duration = Some(ValueRange(5, 5, ValueType.Duration)))
  )
  ...
  val attackDamageIncreasedAfterRuneAttackPlagued = Enchantment("a_adira", EnchantGroup.Attack, "enchantment.attackDamageIncreasedAfterRuneAttack",
    "[StatDamage] <b>Attack Damage</b> increased by {0} for {1} seconds after Rune Attack",
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.RuneAttack), duration = Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val attackSpeedIncreased = Enchantment("", EnchantGroup.Other, "enchantment.attackSpeedIncreased",
    ...
    StatModifier(StatType.AttackSpeed, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val attackSpeedIncreasedAfterKill = Enchantment("", EnchantGroup.Other, "enchantment.attackSpeedIncreasedAfterKill",
    ...
    StatModifier(StatType.AttackSpeed, ValueRange(1, 100, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Kill), Some(ValueRange(1, 10, ValueType.Percentage)))
  )
  ...
  val attackSpeedScalesWithDurability = Enchantment("a_asswd", EnchantGroup.Attack, "enchantment.attackSpeedScalesWithDurability",
    ...
    StatModifier(StatType.AttackSpeed, ScalingValue(ValueRange(3, 10, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val attackSpeedScalesWithDurabilityPlagued = Enchantment("a_asid", EnchantGroup.Attack, "enchantment.attackSpeedScalesWithDurability",
    "[StatAttackSpeed] <b>Attack Speed</b> increased by up to {0} based on Durability",
    StatModifier(StatType.AttackSpeed, ScalingValue(ValueRange(7, 15, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val attackStaminaCostDecreased = Enchantment("a_ascd", EnchantGroup.Attack, "enchantment.attackStaminaCostDecreased",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(7, 15, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val attackStaminaCostDecreasedAfterParry = Enchantment("s_ascdp", EnchantGroup.Stamina, "enchantment.attackStaminaCostDecreasedAfterParry",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease, ActionCondition(ActionType.Parry), Some(ValueRange(5, 5, ValueType.Duration)))
  )
  ...
  val attackStaminaCostDecreasedAfterParryPlagued = Enchantment("s_ascdp", EnchantGroup.Stamina, "enchantment.attackStaminaCostDecreasedAfterParry",
    "[StatStaminaCost] <b>Attack Stamina Cost</b> decreased by {0} for {1} seconds after Parry",
    StatModifier(StatType.StaminaCost, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, ActionCondition(ActionType.Parry), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val attackStaminaCostIncreased = Enchantment("down_asci", EnchantGroup.Downside, "enchantment.attackStaminaCostIncreased",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(20, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val bombDamageIncreased = Enchantment("o_bdi", EnchantGroup.Other, "enchantment.bombDamageIncreased",
    ...
    StatModifier(StatType.BombDamage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val buildupResistance = Enchantment("", EnchantGroup.Other, "enchantment.buildupResistance",
    ...
    StatModifier(StatType.BuildupResistance, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val burnBuildupIncreased = Enchantment("a_bbi", EnchantGroup.Attack, "enchantment.burnBuildupIncreased",
    ...
    StatModifier(StatType.BurnBuildup, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  
  val burnBuildupIncreasedPlagued = Enchantment("a_bbi", EnchantGroup.Attack, "enchantment.burnBuildupIncreased",
    "[StatFireDamage] [!sFire]Burn Buildup[/s] increased by {0}",
    StatModifier(StatType.BurnBuildup, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val burnDamageIncreased = Enchantment("a_bdi", EnchantGroup.Attack, "enchantment.burnDamageIncreased",
    ...
    StatModifier(StatType.FireDamage, ValueRange(25, 50, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val chanceToIngoreDurabilityLoss = Enchantment("u_ctidl", EnchantGroup.Durability, "enchantment.chanceToIngoreDurabilityLoss",
    ...
    ActionModifier(ActionType.DurabilityLoss, ModificationType.Ignore, ValueRange(6, 20, ValueType.Percentage))
  )
  ...
  val chanceToNotConsumeBomb = Enchantment("o_bnc", EnchantGroup.Other, "enchantment.chanceToNotConsumeBomb",
    ...
    ActionModifier(ActionType.BombConsumed, ModificationType.Ignore, ValueRange(10, 20, ValueType.Percentage))
  )
  ...
  val chanceToSpawnExplosionOnRuneAttack = Enchantment("a_ctseora", EnchantGroup.Attack, "enchantment.chanceToSpawnExplosionOnRuneAttack",
    ...
    ActionTrigger(ActionType.Explosion, ValueRange(15, 50, ValueType.Flat), ActionCondition(ActionType.RuneAttack), Some(ValueRange(10, 10, ValueType.Percentage)))
  )
  ...
  val chargedDamageIncreased = Enchantment("a_cadi", EnchantGroup.Attack, "enchantment.chargedDamageIncreased",
    ...
    StatModifier(StatType.ChargedAttackDamage, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.ChargedAttack))
  )
  ...
  val coldDamageIncreased = Enchantment("a_hme3", EnchantGroup.Attack, "enchantment.coldDamageIncreased",
    ...
    StatModifier(StatType.ColdDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val coldDamageIncreasedPlagued = Enchantment("a_cdi", EnchantGroup.Attack, "enchantment.coldDamageIncreased",
    "[StatColdDamage] [!sIce]Ice Damage[/s] increased by {0}",
    StatModifier(StatType.ColdDamage, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val coldDamageIncreasedAfterHeatDamageDealt = Enchantment("", EnchantGroup.Other, "enchantment.coldDamageIncreasedAfterHeatDamageDealt",
    ...
    StatModifier(StatType.ColdDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, AndCondition(ActionCondition(ActionType.DamageDealt), ElementCondition(ElementType.Fire)), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val coldDamageOverride = Enchantment("n_cdo", EnchantGroup.Infusion, "enchantment.coldDamageOverride",
    ...
    ElementalInfusion(ElementType.Ice)
  )
  ...
  val coldResistanceIncreased = Enchantment("r_cri", EnchantGroup.Resistance, "enchantment.coldResistanceIncreased",
    ...
    StatModifier(StatType.ColdArmor, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val damageDecreasedAfterParryOrDodged = Enchantment("", EnchantGroup.Other, "enchantment.damageDecreasedAfterParryOrDodged",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase, OrCondition(ActionCondition(ActionType.Parry), ActionCondition(ActionType.Dodged)), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  
  val damageIncreased = Enchantment("a_di", EnchantGroup.Attack, "enchantment.damageIncreased",
    "[StatDamage] <b>Damage</b> increased by {0}",
    StatModifier(StatType.Damage, ValueRange(3, 10, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val damageIncreasedAfterBackstab = Enchantment("a_diab", EnchantGroup.Attack, "enchantment.damageIncreasedAfterBackstab",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Backstab), Some(ValueRange(30, 30, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterBlock = Enchantment("a_diab", EnchantGroup.Attack, "enchantment.damageIncreasedAfterBlock",
    ...
    StatModifier(StatType.Damage, ValueRange(5, 10, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Block), Some(ValueRange(5, 5, ValueType.Duration)))
  )
  
  val damageIncreasedAfterBlockPlagued = Enchantment("a_dib", EnchantGroup.Attack, "enchantment.damageIncreasedAfterBlock",
    "[StatDamage] <b>Damage</b> increased by {0} for {1} seconds after Block",
    StatModifier(StatType.Damage, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Block), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterDamageTaken = Enchantment("", EnchantGroup.Other, "enchantment.damageIncreasedAfterDamageTaken",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.DamageTaken), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterDodged = Enchantment("a_diad", EnchantGroup.Attack, "enchantment.damageIncreasedAfterDodged",
    ...
    StatModifier(StatType.Damage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Dodged), Some(ValueRange(5, 5, ValueType.Duration)))
  )
  
  val damageIncreasedAfterDodgedPlagued = Enchantment("a_didd", EnchantGroup.Attack, "enchantment.damageIncreasedAfterDodged",
    "[StatDamage] <b>Damage</b> increased by {0} for {1} seconds after Damage Dodged",
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Dodged), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterFatality = Enchantment("a_dif", EnchantGroup.Attack, "enchantment.damageIncreasedAfterFatality",
    ...
    StatModifier(StatType.Damage, ValueRange(20, 40, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Fatality), Some(ValueRange(20, 20, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterParry = Enchantment("a_diap", EnchantGroup.Attack, "enchantment.damageIncreasedAfterParry",
    ...
    StatModifier(StatType.Damage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Parry), Some(ValueRange(5, 5, ValueType.Duration)))
  )
  
  val damageIncreasedAfterParryPlagued = Enchantment("a_dip", EnchantGroup.Attack, "enchantment.damageIncreasedAfterParry",
    "[StatDamage] <b>Damage</b> increased by {0} for {1} seconds after Parry",
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Parry), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val damageIncreasedAfterSprint = Enchantment("a_dis", EnchantGroup.Other, "enchantment.damageIncreasedAfterSprint",
    ...
    StatModifier(StatType.Damage, ValueRange(5, 10, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.Sprinting, Some(ValueRange(2, 2, ValueType.Duration))))
  )
  ...
  val damageIncreasedAfterStagger = Enchantment("a_dis", EnchantGroup.Attack, "enchantment.damageIncreasedAfterStagger",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Stagger), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val damageIncreasedAgainstLargeEnemies = Enchantment("a_dlei", EnchantGroup.Attack, "enchantment.damageIncreasedAgainstLargeEnemies",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, EnemyCondition(EnemyType.Large))
  )
  ...
  val damageIncreasedAgainstLowHealth = Enchantment("", EnchantGroup.Other, "enchantment.damageIncreasedAgainstLowHealth",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, EnemyCondition(EnemyType.LowHealth))
  )
  ...
  val damageIncreasedAtFullFocus = Enchantment("a_diff", EnchantGroup.Attack, "enchantment.damageIncreasedAtFullFocus",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.FullFocus))
  )
  ...
  val damageIncreasedAtHighFocus = Enchantment("a_diahf", EnchantGroup.Attack, "enchantment.damageIncreasedAtHighFocus",
    ...
    StatModifier(StatType.Damage, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.HighFocus))
  )
  ...
  val damageIncreasedAtFullHealth = Enchantment("a_diff", EnchantGroup.Attack, "enchantment.damageIncreasedAtFullHealth",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.FullHealth))
  )
  ...
  val damageIncreasedAtLowHealth = Enchantment("a_dilh", EnchantGroup.Attack, "enchantment.damageIncreasedAtLowHealth",
    ...
    StatModifier(StatType.Damage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.LowHealth))
  )
  ...
  val damageIncreasedPerNearbyEnemy = Enchantment("a_dipne", EnchantGroup.Attack, "enchantment.damageIncreasedPerNearbyEnemy",
    ...
    StatModifier(StatType.Damage, ValueRange(2, 5, ValueType.Percentage), ModificationType.Increase, EnemyCondition(EnemyType.Nearby))
  )
  ...
  val damageIncreasedWhenNoNearbyEnemy = Enchantment("a_diwnne", EnchantGroup.Attack, "enchantment.damageIncreasedWhenNoNearbyEnemy",
    ...
    StatModifier(StatType.Damage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.NoEnemiesNearby))
  )
  ...
  val damageIncreasedWhenNoNearbyEnemyPlagued = Enchantment("a_dinen", EnchantGroup.Attack, "enchantment.damageIncreasedWhenNoNearbyEnemy",
    "[StatDamage] <b>Damage</b> increased by {0} if no Enemies nearby",
    StatModifier(StatType.Damage, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.NoEnemiesNearby))
  )
  ...
  val damageScalesWithCurrentFocus = Enchantment("", EnchantGroup.Other, "enchantment.damageScalesWithCurrentFocus",
    ...
    StatModifier(StatType.Damage, ScalingValue(ValueRange(0, 200, ValueType.Percentage), StatType.CurrentFocus), ModificationType.Increase)
  )
  ...
  val damageScalesWithDurability = Enchantment("a_dswd", EnchantGroup.Attack, "enchantment.damageScalesWithDurability",
    ...
    StatModifier(StatType.Damage, ScalingValue(ValueRange(3, 10, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  
  val damageScalesWithDurabilityPlagued = Enchantment("a_did", EnchantGroup.Attack, "enchantment.damageScalesWithDurability",
    "[StatDamage] <b>Damage</b> increased by up to {0} based on Durability",
    StatModifier(StatType.Damage, ScalingValue(ValueRange(7, 15, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val damageScalesWithMissingHealth = Enchantment("", EnchantGroup.Other, "enchantment.damageScalesWithMissingHealth",
    ...
    StatModifier(StatType.Damage, ScalingValue(ValueRange(0, 200, ValueType.Percentage), StatType.MissingHealth), ModificationType.Increase)
  )
  ...
  val damageTakenDecreasedAfterBuildupTaken = Enchantment("d_dtdbas", EnchantGroup.Defense, "enchantment.damageTakenDecreasedAfterBuildupTaken",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(25, 50, ValueType.Percentage), ModificationType.Decrease, ActionCondition(ActionType.Afflicted), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val damageTakedDecreasedAtLowFocus = Enchantment("d_dtdlf", EnchantGroup.Defense, "enchantment.damageTakedDecreasedAtLowFocus",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(5, 10, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowFocus))
  )
  ...
  val damageTakenDecreasedAtLowHealth = Enchantment("d_dtdalh", EnchantGroup.Defense, "enchantment.damageTakenDecreasedAtLowHealth",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(6, 20, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val damageTakenDecreasedAtLowHealthPlagued = Enchantment("d_dtdlh", EnchantGroup.Defense, "enchantment.damageTakenDecreasedAtLowHealth",
    "[StatDamageTaken] <b>Damage Taken</b> decreased by {0} at Low Health",
    StatModifier(StatType.DamageTaken, ValueRange(12, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val damageTakenDecreasedAtFullFocus = Enchantment("d_dtdff", EnchantGroup.Defense, "enchantment.damageTakenDecreasedAtFullFocus",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(12, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.FullFocus))
  )
  ...
  val damageTakenDecreasedAtFullStamina = Enchantment("d_dtdafs", EnchantGroup.Defense, "enchantment.damageTakenDecreasedAtFullStamina",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(6, 20, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.FullStamina))
  )
  ...
  val damageTakenDecreasedPerNearbyEnemy = Enchantment("d_dtdpne", EnchantGroup.Defense, "enchantment.damageTakenDecreasedPerNearbyEnemy",
    ...
    // TODO fix this
    StatModifier(StatType.DamageTaken, ValueRange(2, 5, ValueType.Percentage), ModificationType.Decrease, EnemyCondition(EnemyType.Nearby))
  )
  ...
  val damageTakenDecreasedWhileBlocking = Enchantment("d_dtdb", EnchantGroup.Defense, "enchantment.damageTakenDecreasedWhileBlocking",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(7, 15, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.Blocking))
  )
  ...
  val damageTakenDecreasedWhileCharging = Enchantment("d_dtdc", EnchantGroup.Defense, "enchantment.damageTakenDecreasedWhileCharging",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(10, 20, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.Charging))
  )
  ...
  val damageTakenIncreasedAfterConsumeFood = Enchantment("", EnchantGroup.Other, "enchantment.damageTakenIncreasedAfterConsumeFood",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.ConsumeFood), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val damageTakenIncreasedAfterDamageTaken = Enchantment("down_dtiadt", EnchantGroup.Downside, "enchantment.damageTakenIncreasedAfterDamageTaken",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(21, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.DamageTaken), Some(ValueRange(6, 6, ValueType.Duration)))
  )
  ...
  val damageTakenIncreasedAtLowStamina = Enchantment("", EnchantGroup.Other, "enchantment.damageTakenIncreasedAtLowStamina",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.LowStamina))
  )
  ...
  val damageTakenIncreasedIfNotFullFocus = Enchantment("down_dtiff", EnchantGroup.Downside, "enchantment.damageTakenIncreasedIfNotFullFocus",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(26, 40, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.NotFullFocus))
  )
  ...
  val damageTakenScalesWithDurability = Enchantment("d_dtswd", EnchantGroup.Defense, "enchantment.damageTakenScalesWithDurability",
    ...
    StatModifier(StatType.DamageTaken, ScalingValue(ValueRange(2, 6, ValueType.Percentage), StatType.Durability), ModificationType.Decrease)
  )
  ...
  val damageTakenScalesWithDurabilityPlagued = Enchantment("d_dtdd", EnchantGroup.Defense, "enchantment.damageTakenScalesWithDurability",
    "[StatDamageTaken] <b>Damage Taken</b> decreased by up to {0} based on Durability",
    StatModifier(StatType.DamageTaken, ScalingValue(ValueRange(5, 10, ValueType.Percentage), StatType.Durability), ModificationType.Decrease)
  )
  ...
  val dealColdDamageOnBlock = Enchantment("", EnchantGroup.Other, "enchantment.dealColdDamageOnBlock",
    ...
    ActionTrigger(ActionType.IceDamage, ValueRange(0, 0, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val dealDamageOnBlock = Enchantment("a_ddob", EnchantGroup.Attack, "enchantment.dealDamageOnBlock",
    ...
    ActionTrigger(ActionType.Damage, ValueRange(5, 15, ValueType.Percentage), ActionCondition(ActionType.Block))
  )
  
  val dealDamageOnBlockPlagued = Enchantment("a_ddb", EnchantGroup.Attack, "enchantment.dealDamageOnBlock",
    "Deal {0} [StatPhysicalDamage] [!sPhysical]Damage[/s] on Block",
    ActionTrigger(ActionType.Damage, ValueRange(10, 20, ValueType.Percentage), ActionCondition(ActionType.Block))
  )
  ...
  val dealDamageOnDamageTaken = Enchantment("a_ddt", EnchantGroup.Attack, "enchantment.dealDamageOnDamageTaken",
    ...
    ActionTrigger(ActionType.Damage, ValueRange(4, 15, ValueType.Percentage), ActionCondition(ActionType.DamageTaken))
  )
  ...
  val dealDamageOnDodged = Enchantment("a_dddd", EnchantGroup.Attack, "enchantment.dealDamageOnDodged",
    ...
    ActionTrigger(ActionType.Damage, ValueRange(4, 15, ValueType.Percentage), ActionCondition(ActionType.DamageDodged))
  )
  ...
  val dealDamageOnParry = Enchantment("a_ddop", EnchantGroup.Attack, "enchantment.dealDamageOnParry",
    ...
    ActionTrigger(ActionType.Damage, ValueRange(7, 25, ValueType.Percentage), ActionCondition(ActionType.Parry))
  )
  
  val dealDamageOnParryPlagued = Enchantment("a_ddp", EnchantGroup.Attack, "enchantment.dealDamageOnParry",
    "Deal {0} [StatPhysicalDamage] [!sPhysical]Damage[/s] on Parry",
    ActionTrigger(ActionType.Damage, ValueRange(15, 30, ValueType.Percentage), ActionCondition(ActionType.Parry))
  )
  ...
  val dealDamageOnStagger = Enchantment("a_ddos", EnchantGroup.Attack, "enchantment.dealDamageOnStagger",
    ...
    ActionTrigger(ActionType.Damage, ValueRange(7, 25, ValueType.Percentage), ActionCondition(ActionType.Stagger))
  )
  
  val dealDamageOnStaggerPlagued = Enchantment("a_ddse", EnchantGroup.Attack, "enchantment.dealDamageOnStagger",
    "Deal {0} [StatPhysicalDamage] [!sPhysical]Damage[/s] on Staggering an Enemy",
    ActionTrigger(ActionType.Damage, ValueRange(15, 30, ValueType.Percentage), ActionCondition(ActionType.Stagger))
  )
  ...
  val dealElectricDamageOnBlock = Enchantment("", EnchantGroup.Other, "enchantment.dealElectricDamageOnBlock",
    ...
    ActionTrigger(ActionType.LightningDamage, ValueRange(0, 0, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val dealHeatDamageOnBlock = Enchantment("", EnchantGroup.Other, "enchantment.dealHeatDamageOnBlock",
    ...
    ActionTrigger(ActionType.FireDamage, ValueRange(0, 0, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val dealHeatDamageOnRuneAttack = Enchantment("", EnchantGroup.Other, "enchantment.dealHeatDamageOnRuneAttack",
    ...
    ActionTrigger(ActionType.FireDamage, ValueRange(0, 0, ValueType.Flat), ActionCondition(ActionType.RuneAttack))
  )
  ...
  val dodgeStaminaCostDecreased = Enchantment("s_dscd", EnchantGroup.Stamina, "enchantment.dodgeStaminaCostDecreased",
    ...
    StatModifier(StatType.DodgeStaminaCost, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val dodgeStaminaCostDecreasedAtLowHealth = Enchantment("s_dscdlh", EnchantGroup.Stamina, "enchantment.dodgeStaminaCostDecreasedAtLowHealth",
    ...
    StatModifier(StatType.DodgeStaminaCost, ValueRange(18, 35, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val dodgeStaminaCostIncreased = Enchantment("down_dsci", EnchantGroup.Downside, "enchantment.dodgeStaminaCostIncreased",
    ...
    StatModifier(StatType.DodgeStaminaCost, ValueRange(26, 40, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val durabilityIncreased = Enchantment("u_di", EnchantGroup.Durability, "enchantment.durabilityIncreased",
    ...
    StatModifier(StatType.Durability, ValueRange(30, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val elementalDamageTakenDecreased = Enchantment("", EnchantGroup.Other, "enchantment.elementalDamageTakenDecreased",
    ...
    StatModifier(StatType.ElementalDamageTaken, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val enemyArmorDecreasedAfterFrost = Enchantment("a_fea", EnchantGroup.Attack, "enchantment.enemyArmorDecreasedAfterFrost",
    ...
    // TODO EnemyModifier?
    StatModifier(StatType.EnemyArmor, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, EnemyCondition(EnemyType.Frozen))
  )
  ...
  val enemyStaggerResistanceDecreasedAfterInfection = Enchantment("a_iesrd", EnchantGroup.Attack, "enchantment.enemyStaggerResistanceDecreasedAfterInfection",
    ...
    StatModifier(StatType.EnemyStaggerResistance, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, EnemyCondition(EnemyType.Infected))
  )
  ...
  val equipLoadDecreased = Enchantment("down_eld", EnchantGroup.Downside, "enchantment.equipLoadDecreased",
    ...
    StatModifier(StatType.EquipLoad, ValueRange(20, 30, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val equipLoadIncreased = Enchantment("", EnchantGroup.Other, "enchantment.equipLoadIncreased",
    ...
    StatModifier(StatType.EquipLoad, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val executeAgainstInfectedLowHealth = Enchantment("a_elhe", EnchantGroup.Attack, "enchantment.executeAgainstInfectedLowHealth",
    ...
    ActionTrigger(ActionType.Execute, ValueRange(100, 100, ValueType.Flat), AndCondition(StatusEffectCondition(StatusEffect.Infected), EnemyCondition(EnemyType.LowHealth)))
  )
  ...
  val experienceGainIncreased = Enchantment("", EnchantGroup.Other, "enchantment.experienceGainIncreased",
    ...
    StatModifier(StatType.ExperienceGain, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val fireDamageIncreased = Enchantment("a_hme2", EnchantGroup.Attack, "enchantment.fireDamageIncreased",
    ...
    StatModifier(StatType.FireDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val fireDamageIncreasedPlagued = Enchantment("a_hdi", EnchantGroup.Attack, "enchantment.fireDamageIncreased",
    "[StatFireDamage] [!sFire]Fire Damage[/s] increased by {0}",
    StatModifier(StatType.FireDamage, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val fireDamageOverride = Enchantment("n_fdo", EnchantGroup.Infusion, "enchantment.fireDamageOverride",
    ...
    ElementalInfusion(ElementType.Fire)
  )
  ...
  val fireResistanceIncreased = Enchantment("r_fri", EnchantGroup.Resistance, "enchantment.fireResistanceIncreased",
    ...
    StatModifier(StatType.FireArmor, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val focusCostDecreased = Enchantment("", EnchantGroup.Other, "enchantment.focusCostDecreased",
    ...
    StatModifier(StatType.FocusCost, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val focusCostDecreasedAfterRuneAttack = Enchantment("f_hme11", EnchantGroup.Focus, "enchantment.focusCostDecreasedAfterRuneAttack",
    ...
    StatModifier(StatType.FocusCost, ValueRange(6, 20, ValueType.Percentage), ModificationType.Decrease, ActionCondition(ActionType.RuneAttack), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val focusCostDecreasedAfterStagger = Enchantment("f_cd", EnchantGroup.Focus, "enchantment.focusCostDecreasedAfterStagger",
    ...
    StatModifier(StatType.FocusCost, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, ActionCondition(ActionType.Stagger), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val focusCostDecreasedAtFullFocus = Enchantment("f_hme7", EnchantGroup.Focus, "enchantment.focusCostDecreasedAtFullFocus",
    ...
    StatModifier(StatType.FocusCost, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.FullFocus))
  )
  ...
  val focusCostDecreasedAtLowHealth = Enchantment("f_hme8", EnchantGroup.Focus, "enchantment.focusCostDecreasedAtLowHealth",
    ...
    StatModifier(StatType.FocusCost, ValueRange(6, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val focusCostDecreasedAtLowHealthPlagued = Enchantment("f_fcslh", EnchantGroup.Focus, "enchantment.focusCostDecreasedAtLowHealth",
    "[StatFocusGain] <b>Focus Cost</b> decreased by {0} at Low Health",
    StatModifier(StatType.FocusCost, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val focusCostIncreased = Enchantment("down_fci", EnchantGroup.Downside, "enchantment.focusCostIncreased",
    ...
    StatModifier(StatType.FocusCost, ValueRange(26, 40, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val focusCostScalesWithMissingHealth = Enchantment("", EnchantGroup.Other, "enchantment.focusCostScalesWithMissingHealth",
    ...
    StatModifier(StatType.FocusCost, ScalingValue(ValueRange(0, 100, ValueType.Percentage), StatType.MissingHealth), ModificationType.Decrease)
  )
  ...
  val focusGainDecreased = Enchantment("down_fgd", EnchantGroup.Downside, "enchantment.focusGainDecreased",
    ...
    StatModifier(StatType.FocusGain, ValueRange(32, 50, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val focusGainIncreased = Enchantment("f_hme6", EnchantGroup.Focus, "enchantment.focusGainIncreased",
    ...
    StatModifier(StatType.FocusGain, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val focusGainScalesWithDurability = Enchantment("f_fgswd", EnchantGroup.Focus, "enchantment.focusGainScalesWithDurability",
    ...
    StatModifier(StatType.FocusGain, ScalingValue(ValueRange(4, 15, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  
  val focusGainScalesWithDurabilityPlagued = Enchantment("f_gi", EnchantGroup.Focus, "enchantment.focusGainScalesWithDurability",
    "[StatFocusGain] <b>Focus Gain</b> increased by up to {0} based on Durability",
    StatModifier(StatType.FocusGain, ScalingValue(ValueRange(10, 20, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val frostBuildupIncreased = Enchantment("a_fbi", EnchantGroup.Attack, "enchantment.frostBuildupIncreased",
    ...
    StatModifier(StatType.FrostBuildup, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  
  val frostBuildupIncreasedPlagued = Enchantment("a_fbi", EnchantGroup.Attack, "enchantment.frostBuildupIncreased",
    "[StatColdDamage] [!sIce]Frost Buildup[/s] increased by {0}",
    StatModifier(StatType.FrostBuildup, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val gainFocusOnBackstab = Enchantment("o_gfob", EnchantGroup.Focus, "enchantment.gainFocusOnBackstab",
    ...
    ResourceGain(StatType.Focus, ValueRange(5, 10, ValueType.Flat), ActionCondition(ActionType.Backstab))
  )
  ...
  val gainFocusOnBlock = Enchantment("f_gfob", EnchantGroup.Focus, "enchantment.gainFocusOnBlock",
    ...
    ResourceGain(StatType.Focus, ValueRange(2, 5, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val gainFocusOnBuildup = Enchantment("f_hme9", EnchantGroup.Focus, "enchantment.gainFocusOnBuildup",
    ...
    ResourceGain(StatType.Focus, ValueRange(3, 10, ValueType.Flat), ActionCondition(ActionType.DamageDealt))
  )
  
  val gainFocusOnBuildupPlagued = Enchantment("f_gb", EnchantGroup.Focus, "enchantment.gainFocusOnBuildup",
    "Gain {0} [StatFocus] <b>Focus</b> on inflicting Any Status",
    ResourceGain(StatType.Focus, ValueRange(8, 15, ValueType.Flat), ActionCondition(ActionType.DamageDealt))
  )
  ...
  val gainFocusOnDodged = Enchantment("f_gfod", EnchantGroup.Focus, "enchantment.gainFocusOnDodged",
    ...
    ResourceGain(StatType.Focus, ValueRange(5, 15, ValueType.Flat), ActionCondition(ActionType.Dodged))
  )
  ...
  val gainFocusOnFatality = Enchantment("f_gff", EnchantGroup.Focus, "enchantment.gainFocusOnFatality",
    ...
    ResourceGain(StatType.Focus, ValueRange(12, 25, ValueType.Flat), ActionCondition(ActionType.Fatality))
  )
  
  val gainFocusOnKill = Enchantment("f_gfk", EnchantGroup.Focus, "enchantment.gainFocusOnKill",
    "Gain {0} [StatFocus] <b>Focus</b> on Kill",
    ResourceGain(StatType.Focus, ValueRange(8, 15, ValueType.Flat), ActionCondition(ActionType.Kill))
  )
  ...
  val gainFocusOnParry = Enchantment("f_gfop", EnchantGroup.Focus, "enchantment.gainFocusOnParry",
    ...
    ResourceGain(StatType.Focus, ValueRange(5, 15, ValueType.Flat), ActionCondition(ActionType.Parry))
  )
  ...
  val gainFocusOnStagger = Enchantment("f_gfos", EnchantGroup.Focus, "enchantment.gainFocusOnStagger",
    ...
    ResourceGain(StatType.Focus, ValueRange(3, 10, ValueType.Flat), ActionCondition(ActionType.Stagger))
  )
  ...
  val gainHealthForFocusSpent = Enchantment("h_hfs", EnchantGroup.Healing, "enchantment.gainHealthForFocusSpent",
    ...
    ResourceGain(StatType.Health, ScalingValue(ValueRange(1, 10, ValueType.Percentage), StatType.FocusSpent), ActionCondition(ActionType.FocusUse))
  )
  ...
  val gainHealthOnBackstab = Enchantment("o_ghob", EnchantGroup.Other, "enchantment.gainHealthOnBackstab",
    ...
    ResourceGain(StatType.Health, ValueRange(3, 5, ValueType.Percentage), ActionCondition(ActionType.Backstab))
  )
  ...
  val gainHealthOnChargedAttack = Enchantment("h_ghca", EnchantGroup.Healing, "enchantment.gainHealthOnChargedAttack",
    ...
    ResourceGain(StatType.Health, ValueRange(2, 4, ValueType.Percentage), ActionCondition(ActionType.ChargedAttack))
  )
  ...
  val gainHealthOnDamageDealtAgainstFrozen = Enchantment("h_ghdaf", EnchantGroup.Healing, "enchantment.gainHealthOnDamageDealtAgainstFrozen",
    ...
    ResourceGain(StatType.Health, ValueRange(1, 2, ValueType.Percentage), AndCondition(ActionCondition(ActionType.DamageDealt), EnemyCondition(EnemyType.Frozen)))
  )
  ...
  val gainHealthOnDamageDealtAtLowHealth = Enchantment("", EnchantGroup.Other, "enchantment.gainHealthOnDamageDealtAtLowHealth",
    ...
    ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), AndCondition(ActionCondition(ActionType.DamageDealt), StateCondition(ConditionType.LowHealth)))
  )
  ...
  val gainHealthOnDodged = Enchantment("h_ghdd", EnchantGroup.Healing, "enchantment.gainHealthOnDodged",
    ...
    ResourceGain(StatType.Health, ValueRange(3, 5, ValueType.Percentage), ActionCondition(ActionType.Dodged))
  )
  ...
  val gainHealthOnFatality = Enchantment("h_ghf", EnchantGroup.Healing, "enchantment.gainHealthOnFatality",
    ...
    ResourceGain(StatType.Health, ValueRange(5, 10, ValueType.Percentage), ActionCondition(ActionType.Fatality))
  )
  ...
  val gainHealthOnKill = Enchantment("h_ghok", EnchantGroup.Healing, "enchantment.gainHealthOnKill",
    ...
    ResourceGain(StatType.Health, ValueRange(3, 10, ValueType.Percentage), ActionCondition(ActionType.Kill))
  )
  
  val gainHealthOnKillPlagued = Enchantment("h_ghk", EnchantGroup.Healing, "enchantment.gainHealthOnKill",
    "Gain {0} [StatHealth] <b>Health</b> on Kill",
    ResourceGain(StatType.Health, ValueRange(5, 10, ValueType.Percentage), ActionCondition(ActionType.Kill))
  )
  ...
  val gainHealthOnKillAgainstStaggeredEnemies = Enchantment("", EnchantGroup.Other, "enchantment.gainHealthOnKillAgainstStaggeredEnemies",
    ...
    ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), AndCondition(ActionCondition(ActionType.Kill), EnemyCondition(EnemyType.Staggered)))
  )
  ...
  val gainHealthOnParry = Enchantment("h_ghp", EnchantGroup.Healing, "enchantment.gainHealthOnParry",
    ...
    ResourceGain(StatType.Health, ValueRange(2, 6, ValueType.Percentage), ActionCondition(ActionType.Parry))
  )
  ...
  val gainHealthOnStagger = Enchantment("h_ghse", EnchantGroup.Healing, "enchantment.gainHealthOnStagger",
    ...
    ResourceGain(StatType.Health, ValueRange(5, 10, ValueType.Percentage), ActionCondition(ActionType.Stagger))
  )
  ...
  val gainHealthOncePerRuneAttack = Enchantment("", EnchantGroup.Other, "enchantment.gainHealthOncePerRuneAttack",
    ...
    ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.RuneAttack))
  )
  ...
  val gainStaminaOnBlock = Enchantment("", EnchantGroup.Other, "enchantment.gainStaminaOnBlock",
    ...
    ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val gainStaminaOnDamageDealt = Enchantment("", EnchantGroup.Other, "enchantment.gainStaminaOnDamageDealt",
    ...
    ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageDealt))
  )
  ...
  val gainStaminaOnDodged = Enchantment("s_gsod", EnchantGroup.Stamina, "enchantment.gainStaminaOnDodged",
    ...
    ResourceGain(StatType.Stamina, ValueRange(5, 15, ValueType.Flat), ActionCondition(ActionType.Dodged))
  )
  ...
  val gainStaminaOnFocusUse = Enchantment("", EnchantGroup.Other, "enchantment.gainStaminaOnFocusUse",
    ...
    ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.FocusUse))
  )
  ...
  val gainStaminaOnParry = Enchantment("s_gsop", EnchantGroup.Stamina, "enchantment.gainStaminaOnParry",
    ...
    ResourceGain(StatType.Stamina, ValueRange(9, 30, ValueType.Flat), ActionCondition(ActionType.Parry))
  )
  ...
  val gainStaminaOnStagger = Enchantment("", EnchantGroup.Other, "enchantment.gainStaminaOnStagger",
    ...
    ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Stagger))
  )
  ...
  val healingDecreased = Enchantment("down_hd", EnchantGroup.Downside, "enchantment.healingDecreased",
    ...
    StatModifier(StatType.Healing, ValueRange(20, 30, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val healingDecreasedPerNearbyEnemy = Enchantment("down_asci", EnchantGroup.Downside, "enchantment.healingDecreasedPerNearbyEnemy",
    ...
    StatModifier(StatType.Healing, ValueRange(9, 14, ValueType.Percentage), ModificationType.Decrease, EnemyCondition(EnemyType.Nearby))
  )
  ...
  val healingIncreased = Enchantment("h_hi", EnchantGroup.Healing, "enchantment.healingIncreased",
    ...
    StatModifier(StatType.Healing, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val healingIncreasedAtLowFocus = Enchantment("h_hilf", EnchantGroup.Healing, "enchantment.healingIncreasedAtLowFocus",
    ...
    StatModifier(StatType.Healing, ValueRange(9, 30, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.LowFocus))
  )
  ...
  val healingScalesWithDurability = Enchantment("h_hswd", EnchantGroup.Healing, "enchantment.healingScalesWithDurability",
    ...
    StatModifier(StatType.Healing, ScalingValue(ValueRange(4, 15, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  
  val healingScalesWithDurabilityPlagued = Enchantment("h_hid", EnchantGroup.Healing, "enchantment.healingScalesWithDurability",
    "[StatHealing] <b>Healing</b> increased by up to {0} based on Durability",
    StatModifier(StatType.Healing, ScalingValue(ValueRange(6, 20, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val healthRallyIncreased = Enchantment("h_hri", EnchantGroup.Healing, "enchantment.healthRallyIncreased",
    ...
    StatModifier(StatType.HealthRally, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val heatDamageIncreasedAfterColdDamageDealt = Enchantment("", EnchantGroup.Other, "enchantment.heatDamageIncreasedAfterColdDamageDealt",
    ...
    StatModifier(StatType.FireDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.DamageDealt), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  
  val hungerIncreased = Enchantment("h_hl", EnchantGroup.Healing, "enchantment.hungerIncreased",
    "<b>Hunger Limit</b> increased by {0}",
    StatModifier(StatType.HungerLimit, ValueRange(1, 1, ValueType.Flat), ModificationType.Increase)
  )
  ...
  val infectionBuildupIncreased = Enchantment("a_ibi", EnchantGroup.Attack, "enchantment.infectionBuildupIncreased",
    ...
    StatModifier(StatType.InfectionBuildup, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  
  val infectionBuildupIncreasedPlagued = Enchantment("a_ibi", EnchantGroup.Attack, "enchantment.infectionBuildupIncreased",
    "[StatPlagueDamage] [!sPlague]Infection Buildup[/s] increased by {0}",
    StatModifier(StatType.InfectionBuildup, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val itemWeightDecreased = Enchantment("w_iwd", EnchantGroup.Weight, "enchantment.itemWeightDecreased",
    ...
    StatModifier(StatType.Weight, ValueRange(3, 10, ValueType.Percentage), ModificationType.Decrease)
  )
  
  val itemWeightDecreasedPlagued = Enchantment("w_iwd", EnchantGroup.Weight, "enchantment.itemWeightDecreased",
    "Item [StatWeight] <b>Weight</b> decreased by {0}",
    StatModifier(StatType.Weight, ValueRange(7, 15, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val itemWeightIncreased = Enchantment("", EnchantGroup.Other, "enchantment.itemWeightIncreased",
    ...
    StatModifier(StatType.Weight, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val knockbackResistanceIncreased = Enchantment("", EnchantGroup.Other, "enchantment.knockbackResistanceIncreased",
    ...
    StatModifier(StatType.Armor, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val lifestealIncreased = Enchantment("", EnchantGroup.Other, "enchantment.lifestealIncreased",
    ...
    StatModifier(StatType.Lifesteal, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val lifestealIncreasedAtLowHealth = Enchantment("", EnchantGroup.Other, "enchantment.lifestealIncreasedAtLowHealth",
    ...
    StatModifier(StatType.Lifesteal, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.LowHealth))
  )
  ...
  val lightningDamageIncreased = Enchantment("a_hme4", EnchantGroup.Attack, "enchantment.lightningDamageIncreased",
    ...
    StatModifier(StatType.LightningDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val lightningDamageIncreasedPlagued = Enchantment("a_ldi", EnchantGroup.Attack, "enchantment.lightningDamageIncreased",
    "[StatLightningDamage] [!sLightning]Lightning Damage[/s] increased by {0}",
    StatModifier(StatType.LightningDamage, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val lightningDamageOverride = Enchantment("n_ldo", EnchantGroup.Infusion, "enchantment.lightningDamageOverride",
    ...
    ElementalInfusion(ElementType.Lightning)
  )
  ...
  val lightningDamageOverrideAfterSprint = Enchantment("", EnchantGroup.Other, "enchantment.lightningDamageOverrideAfterSprint",
    ...
    ElementalInfusion(ElementType.Lightning, StateCondition(ConditionType.Sprinting, Some(ValueRange(1, 10, ValueType.Duration))))
  )
  ...
  val lightningResistanceIncreased = Enchantment("r_lri", EnchantGroup.Resistance, "enchantment.lightningResistanceIncreased",
    ...
    StatModifier(StatType.LightningArmor, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val loseFocusOnDamageTaken = Enchantment("down_lftd", EnchantGroup.Downside, "enchantment.loseFocusOnDamageTaken",
    ...
    ResourceLoss(StatType.Focus, ValueRange(10, 15, ValueType.Flat), ActionCondition(ActionType.DamageTaken))
  )
  ...
  val loseFocusOnFocusUse = Enchantment("", EnchantGroup.Other, "enchantment.loseFocusOnFocusUse",
    ...
    ResourceLoss(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.FocusUse))
  )
  ...
  val loseStaminaOnBlock = Enchantment("", EnchantGroup.Other, "enchantment.loseStaminaOnBlock",
    ...
    ResourceLoss(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Block))
  )
  ...
  val loseStaminaOnDamageTaken = Enchantment("", EnchantGroup.Other, "enchantment.loseStaminaOnDamageTaken",
    ...
    ResourceLoss(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageTaken))
  )
  ...
  val maxFocusDecreased = Enchantment("down_mfd", EnchantGroup.Downside, "enchantment.maxFocusDecreased",
    ...
    StatModifier(StatType.MaxFocus, ValueRange(18, 25, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val maxFocusIncreased = Enchantment("f_hme10", EnchantGroup.Focus, "enchantment.maxFocusIncreased",
    ...
    StatModifier(StatType.MaxFocus, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val maxHealthDecreased = Enchantment("down_mhd", EnchantGroup.Downside, "enchantment.maxHealthDecreased",
    ...
    StatModifier(StatType.MaxHealth, ValueRange(14, 20, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val maxHealthIncreased = Enchantment("h_mhi", EnchantGroup.Healing, "enchantment.maxHealthIncreased",
    ...
    StatModifier(StatType.MaxHealth, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val maxHealthScalesWithMaxFocus = Enchantment("h_mhi", EnchantGroup.Healing, "enchantment.maxHealthScalesWithMaxFocus",
    ...
    StatModifier(StatType.MaxHealth, ScalingValue(ValueRange(5, 10, ValueType.Percentage), StatType.MaxFocus), ModificationType.Increase)
  )
  ...
  val maxStaminaDecreased = Enchantment("down_msd", EnchantGroup.Downside, "enchantment.maxStaminaDecreased",
    ...
    StatModifier(StatType.MaxStamina, ValueRange(14, 20, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val maxStaminaScalesWithMaxFocus = Enchantment("h_msimf", EnchantGroup.Healing, "enchantment.maxStaminaScalesWithMaxFocus",
    ...
    StatModifier(StatType.MaxStamina, ScalingValue(ValueRange(3, 5, ValueType.Percentage), StatType.MaxFocus), ModificationType.Increase)
  )
  ...
  val movementSpeedDecreased = Enchantment("down_msd", EnchantGroup.Downside, "enchantment.movementSpeedDecreased",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val movementSpeedDecreasedPerNearbyEnemy = Enchantment("", EnchantGroup.Other, "enchantment.movementSpeedDecreasedPerNearbyEnemy",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(0, 30, ValueType.Percentage), ModificationType.Decrease, EnemyCondition(EnemyType.Nearby))
  )
  ...
  val movementSpeedIncreased = Enchantment("m_msi", EnchantGroup.Movement , "enchantment.movementSpeedIncreased",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(3, 10, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val movementSpeedIncreasedAfterChargedAttack = Enchantment("m_msica", EnchantGroup.Movement, "enchantment.movementSpeedIncreasedAfterChargedAttack",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(7, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.ChargedAttack), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val movementSpeedIncreasedAfterKill = Enchantment("m_msiak", EnchantGroup.Movement, "enchantment.movementSpeedIncreasedAfterKill",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Kill), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val movementSpeedIncreasedAfterRuneAttack = Enchantment("m_msira", EnchantGroup.Movement, "enchantment.movementSpeedIncreasedAfterRuneAttack",
    ...
    StatModifier(StatType.MovementSpeed, ValueRange(7, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.RuneAttack), Some(ValueRange(5, 5, ValueType.Duration)))
  )
  ...
  val normalDamageIncreasedAfterChargedAttack = Enchantment("a_ndiaca", EnchantGroup.Attack, "enchantment.normalDamageIncreasedAfterChargedAttack",
    ...
    StatModifier(StatType.Damage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.ChargedAttack), Some(ValueRange(4, 4, ValueType.Duration)))
  )
  ...
  val parryStaminaCostDecreased = Enchantment("", EnchantGroup.Other, "enchantment.parryStaminaCostDecreased",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val physicalDamageIncreased = Enchantment("a_pdi", EnchantGroup.Attack, "enchantment.physicalDamageIncreased",
    ...
    StatModifier(StatType.PhysicalDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val physicalDamageIncreasedPlagued = Enchantment("a_pdi", EnchantGroup.Attack, "enchantment.physicalDamageIncreased",
    "[StatPhysicalDamage] [!sPhysical]Physical Damage[/s] increased by {0}",
    StatModifier(StatType.PhysicalDamage, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val physicalDamageTakenDecreased = Enchantment("", EnchantGroup.Other, "enchantment.physicalDamageTakenDecreased",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val plagueDamageIncreased = Enchantment("a_hme5", EnchantGroup.Attack, "enchantment.plagueDamageIncreased",
    ...
    StatModifier(StatType.PlagueDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val plagueDamageIncreasedPlagued = Enchantment("a_pdi", EnchantGroup.Attack, "enchantment.plagueDamageIncreased",
    "[StatPlagueDamage] [!sPlague]Plague Damage[/s] increased by {0}",
    StatModifier(StatType.PlagueDamage, ValueRange(7, 25, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val plagueDamageOverride = Enchantment("n_pdo", EnchantGroup.Infusion, "enchantment.plagueDamageOverride",
    ...
    ElementalInfusion(ElementType.Plague)
  )
  ...
  val plagueResistanceIncreased = Enchantment("r_pri", EnchantGroup.Resistance, "enchantment.plagueResistanceIncreased",
    ...
    StatModifier(StatType.PlagueArmor, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val poiseDefenseIncreased = Enchantment("o_pdi", EnchantGroup.Other, "enchantment.poiseDefenseIncreased",
    ...
    StatModifier(StatType.PoiseDefense, ValueRange(1, 3, ValueType.Flat), ModificationType.Increase)
  )
  ...
  val poiseDefenseIncreasedWhileBlocking = Enchantment("o_pdiwb", EnchantGroup.Other, "enchantment.poiseDefenseIncreasedWhileBlocking",
    ...
    StatModifier(StatType.PoiseDefense, ValueRange(5, 10, ValueType.Flat), ModificationType.Increase, StateCondition(ConditionType.Blocking))
  )
  ...
  val poiseDefenseIncreasedWhileCharging = Enchantment("o_pdic", EnchantGroup.Attack, "enchantment.poiseDefenseIncreasedWhileCharging",
    ...
    StatModifier(StatType.PoiseDefense, ValueRange(5, 10, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.Charging))
  )
  ...
  val refillFocusOnBackstab = Enchantment("", EnchantGroup.Other, "enchantment.refillFocusOnBackstab",
    ...
    ResourceGain(StatType.Focus, ValueRange(100, 100, ValueType.Percentage), ActionCondition(ActionType.Backstab))
  )
  ...
  val regenHealthWhileBlocking = Enchantment("", EnchantGroup.Other, "enchantment.regenHealthWhileBlocking",
    ...
    StatModifier(StatType.HealthRegen, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.Blocking))
  )
  ...
  val runeDamageIncreased = Enchantment("a_rdi", EnchantGroup.Attack, "enchantment.runeDamageIncreased",
    ...
    StatModifier(StatType.Damage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  
  val runeDamageIncreasedPlagued = Enchantment("a_rdi", EnchantGroup.Attack, "enchantment.runeDamageIncreased",
    "[StatDamage] <b>Rune Damage</b> increased by {0}",
    StatModifier(StatType.Damage, ValueRange(10, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val shockBuildupIncreased = Enchantment("a_sbi", EnchantGroup.Attack, "enchantment.shockBuildupIncreased",
    ...
    StatModifier(StatType.LightningDamage, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  
  val shockBuildupIncreasedPlagued = Enchantment("a_sbi", EnchantGroup.Attack, "enchantment.shockBuildupIncreased",
    "[StatLightningDamage] [!sLightning]Shock Buildup[/s] increased by {0}",
    StatModifier(StatType.LightningDamage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val shockBuildupIncreasedAfterShock = Enchantment("", EnchantGroup.Other, "enchantment.shockBuildupIncreasedAfterShock",
    ...
    StatModifier(StatType.LightningDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.Shocked), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val spawnExplosionOnKill = Enchantment("a_seok", EnchantGroup.Attack, "enchantment.spawnExplosionOnKill",
    ...
    ActionTrigger(ActionType.Explosion, ValueRange(25, 50, ValueType.Percentage), ActionCondition(ActionType.Kill))
  )
  ...
  val speedIncreasedAfterShock = Enchantment("m_os", EnchantGroup.Movement, "enchantment.speedIncreasedAfterShock",
    ...
    StatModifier(StatType.AttackSpeed, ValueRange(7, 15, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.Shocked), Some(ValueRange(10, 10, ValueType.Duration)))
  )
  ...
  val staggerDamageIncreased = Enchantment("a_sdi", EnchantGroup.Attack, "enchantment.staggerDamageIncreased",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(4, 15, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val staggerDamageIncreasedAfterBackstab = Enchantment("a_sdiab", EnchantGroup.Attack, "enchantment.staggerDamageIncreasedAfterBackstab",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Backstab), Some(ValueRange(30, 30, ValueType.Duration)))
  )
  ...
  val staggerDamageIncreasedAfterChargedAttack = Enchantment("a_sdiaca", EnchantGroup.Attack, "enchantment.staggerDamageIncreasedAfterChargedAttack",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.ChargedAttack), Some(ValueRange(4, 4, ValueType.Duration)))
  )
  ...
  val staggerDamageIncreasedAfterFatality = Enchantment("a_sdiaf", EnchantGroup.Attack, "enchantment.staggerDamageIncreasedAfterFatality",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(20, 40, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Fatality), Some(ValueRange(20, 20, ValueType.Duration)))
  )
  ...
  val staggerDamageIncreasedAfterKill = Enchantment("a_sdiak", EnchantGroup.Attack, "enchantment.staggerDamageIncreasedAfterKill",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Kill), Some(ValueRange(20, 20, ValueType.Duration)))
  )
  ...
  val staggerDamageIncreasedAtLowHealth = Enchantment("a_sdilh", EnchantGroup.Attack, "enchantment.staggerDamageIncreasedAtLowHealth",
    ...
    StatModifier(StatType.StaggerDamage, ValueRange(12, 25, ValueType.Percentage), ModificationType.Increase, StateCondition(ConditionType.LowHealth))
  )
  ...
  val staggerResistanceDecreased = Enchantment("down_srd", EnchantGroup.Downside, "enchantment.staggerResistanceDecreased",
    ...
    StatModifier(StatType.StaggerResistance, ValueRange(26, 40, ValueType.Percentage), ModificationType.Decrease)
  )
  ...
  val staggerResistanceIncreased = Enchantment("r_sri", EnchantGroup.Resistance, "enchantment.staggerResistanceIncreased",
    ...
    StatModifier(StatType.StaggerResistance, ValueRange(7, 15, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val staminaCostDecreasedAfterFatality = Enchantment("s_scdf", EnchantGroup.Stamina, "enchantment.staminaCostDecreasedAfterFatality",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(15, 30, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.Fatality), Some(ValueRange(20, 20, ValueType.Duration)))
  )
  ...
  val staminaCostDecreasedAtFullHealth = Enchantment("s_scdafh", EnchantGroup.Stamina , "enchantment.staminaCostDecreasedAtFullHealth",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.FullHealth))
  )
  ...
  val staminaCostDecreasedAtHighFocus = Enchantment("s_scdahf", EnchantGroup.Stamina, "enchantment.staminaCostDecreasedAtHighFocus",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(8, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.HighFocus))
  )
  ...
  val staminaCostDecreasedAtLowFocus = Enchantment("s_scdlf", EnchantGroup.Stamina, "enchantment.staminaCostDecreasedAtLowFocus",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(10, 20, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowFocus))
  )
  ...
  val staminaCostDecreasedAtLowHealth = Enchantment("s_scdalh", EnchantGroup.Stamina, "enchantment.staminaCostDecreasedAtLowHealth",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(7, 25, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val staminaCostDecreasedAtLowHealthPlagued = Enchantment("s_scdalh", EnchantGroup.Stamina, "enchantment.staminaCostDecreasedAtLowHealth",
    "[StatStaminaCost] <b>Stamina Cost</b> decreased by {0} at Low Health",
    StatModifier(StatType.StaminaCost, ValueRange(15, 30, ValueType.Percentage), ModificationType.Decrease, StateCondition(ConditionType.LowHealth))
  )
  ...
  val staminaCostIncreased = Enchantment("down_sci", EnchantGroup.Downside, "enchantment.staminaCostIncreased",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(13, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val staminaRefillOnParry = Enchantment("", EnchantGroup.Other, "enchantment.staminaRefillOnParry",
    ...
    ResourceGain(StatType.Stamina, ValueRange(100, 100, ValueType.Percentage), ActionCondition(ActionType.Parry))
  )
  ...
  val staminaRefillOnStagger = Enchantment("", EnchantGroup.Other, "enchantment.staminaRefillOnStagger",
    ...
    ResourceGain(StatType.Stamina, ValueRange(100, 100, ValueType.Percentage), ActionCondition(ActionType.Stagger))
  )
  ...
  val staminaRegenerationIncreased = Enchantment("s_sri", EnchantGroup.Stamina, "enchantment.staminaRegenerationIncreased",
    ...
    StatModifier(StatType.StaminaRegen, ValueRange(6, 20, ValueType.Percentage), ModificationType.Increase)
  )
  ...
  val staminaRegenerationScalesWithDurability = Enchantment("s_srswd", EnchantGroup.Stamina, "enchantment.staminaRegenerationScalesWithDurability",
    ...
    StatModifier(StatType.StaminaRegen, ScalingValue(ValueRange(6, 20, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val staminaRegenerationScalesWithDurabilityPlagued = Enchantment("s_sri", EnchantGroup.Stamina, "enchantment.staminaRegenerationScalesWithDurability",
    "[StatStaminaRegen] <b>Stamina Recovery</b> increased by up to {0} based on Durability",
    StatModifier(StatType.StaminaRegen, ScalingValue(ValueRange(7, 25, ValueType.Percentage), StatType.Durability), ModificationType.Increase)
  )
  ...
  val swapMaxHealthAndMaxFocus = Enchantment("", EnchantGroup.Other, "enchantment.swapMaxHealthAndMaxFocus",
    ...
    SwapStats(StatType.Health, StatType.MaxFocus)
  )
  ...
  val takeDamageOnFocusUse = Enchantment("down_tdfu", EnchantGroup.Downside, "enchantment.takeDamageOnFocusUse",
    ...
    ResourceLoss(StatType.Health, ValueRange(20, 30, ValueType.Percentage), ActionCondition(ActionType.FocusUse))
  )
  ...
  val uniqueBuffSpecialDamageAfterSpecial = Enchantment("", EnchantGroup.Other, "enchantment.unique.buffSpecialDamageAfterSpecial",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.RuneAttack), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val uniqueCorpseSmearedBlade1 = Enchantment("", EnchantGroup.Other, "enchantment.unique.corpseSmearedBlade1",
    ...
    StatModifier(StatType.Lifesteal, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.Tainted))
  )
  ...
  val uniqueCorpseSmearedBlade2 = Enchantment("", EnchantGroup.Other, "enchantment.unique.corpseSmearedBlade2",
    ...
    StatModifier(StatType.MaxStamina, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.Tainted))
  )
  ...
  val uniqueCorpseSmearedBlade3 = Enchantment("", EnchantGroup.Other, "enchantment.unique.corpseSmearedBlade3",
    ...
    StatModifier(StatType.HealthRegen, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease, StatusEffectCondition(StatusEffect.Tainted))
  )
  ...
  val uniqueDamageAgainstBeasts = Enchantment("", EnchantGroup.Other, "enchantment.unique.damageAgainstBeasts",
    ...
    StatModifier(StatType.Damage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, EnemyCondition(EnemyType.Beasts))
  )
  ...
  val uniqueGainFocusOnDamageTaken = Enchantment("", EnchantGroup.Other, "enchantment.unique.gainFocusOnDamageTaken",
    ...
    ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageTaken))
  )
  ...
  val uniqueGlimmeringBulwark0 = Enchantment("", EnchantGroup.Other, "enchantment.unique.glimmeringBulwark0",
    ...
    StatModifier(StatType.Enlightment, ValueRange(1, 1, ValueType.Flat), ModificationType.Increase, ActionCondition(ActionType.Parry), Some(ValueRange(1, 30, ValueType.Duration)))
  )
  ...
  val uniqueGlimmeringBulwark2 = Enchantment("", EnchantGroup.Other, "enchantment.unique.glimmeringBulwark2",
    ...
    StatModifier(StatType.FocusGain, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.Enlightened))
  )
  ...
  val uniqueHealthLossOnDamageDealt = Enchantment("", EnchantGroup.Other, "enchantment.unique.healthLossOnDamageDealt",
    ...
    ResourceLoss(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageDealt))
  )
  ...
  val uniqueTarnishedWand1 = Enchantment("", EnchantGroup.Other, "enchantment.unique.tarnishedWand1",
    ...
    StatModifier(StatType.StaminaCost, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease, StatusEffectCondition(StatusEffect.Enlightened))
  )
  ...
  val uniqueTarnishedWand2 = Enchantment("", EnchantGroup.Other, "enchantment.unique.tarnishedWand2",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease, StatusEffectCondition(StatusEffect.Enlightened))
  )
  ...
  val uniqueTheDawnNeverCome2 = Enchantment("", EnchantGroup.Other, "enchantment.unique.theDawnNeverCome2",
    ...
    StatModifier(StatType.Lifesteal, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.SecondToll))
  )
  ...
  val uniqueTheDawnNeverCome3 = Enchantment("", EnchantGroup.Other, "enchantment.unique.theDawnNeverCome3",
    ...
    StatModifier(StatType.DamageTaken, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, StatusEffectCondition(StatusEffect.ThirdToll))
  )
  ...
  val uniqueTheDawnNeverComes0 = Enchantment("", EnchantGroup.Other, "enchantment.unique.theDawnNeverComes0",
    ...
    StatModifier(StatType.Damage, ValueRange(1, 30, ValueType.Duration), ModificationType.Increase, ActionCondition(ActionType.DamageTaken))
  )
  ...
  val uniqueWeaponsBleedersDelightChanceStaggerDamageOnDamageDealt = Enchantment("", EnchantGroup.Other, "enchantment.unique.weapons.bleedersDelight.chanceStaggerDamageOnDamageDealt",
    ...
    ChanceEffect(ValueRange(0, 100, ValueType.Chance), StatModifier(StatType.StaggerDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase, ActionCondition(ActionType.DamageDealt)))
  )
}
