...
// format: off
  ...
  val allEnchantments = List(
    Enchantment("enchantment.armorDecreased",
    ...
    Enchantment("enchantment.armorIncreased",
    ...
    Enchantment("enchantment.attackDamageDecreased",
    ...
    Enchantment("enchantment.attackDamageIncreased",
    ...
    Enchantment("enchantment.attackDamageIncreasedAfterRuneAttack",
    ...
    Enchantment("enchantment.attackSpeedIncreased",
    ...
    Enchantment("enchantment.attackSpeedIncreasedAfterKill",
    ...
    Enchantment("enchantment.attackStaminaCostDecreased",
    ...
    Enchantment("enchantment.attackStaminaCostDecreasedAfterParry",
    ...
    Enchantment("enchantment.attackStaminaCostIncreased",
    ...
    Enchantment("enchantment.blockingDisabled",
      "<b>Block</b> disabled",
      List(BlockingDisabled)
    ),
    
    Enchantment("enchantment.bombDamageIncreased",
    ...
    Enchantment("enchantment.buildupResistance",
    ...
    Enchantment("enchantment.burnBuildupIncreased",
    ...
    Enchantment("enchantment.burnDamageIncreased",
    ...
    Enchantment("enchantment.chanceToIngoreDurabilityLoss",
    ...
    Enchantment("enchantment.chanceToNotConsumeBomb",
    ...
    Enchantment("enchantment.chanceToSpawnExplosionOnRuneAttack",
    ...
    Enchantment("enchantment.chargedDamageIncreased",
    ...
    Enchantment("enchantment.coldDamageIncreasedAfterHeatDamageDealt",
    ...
    Enchantment("enchantment.coldResistanceIncreased",
    ...
    Enchantment("enchantment.damageDecreasedAfterParryOrDodged",
    ...
    Enchantment("enchantment.damageIncreased",
    ...
    Enchantment("enchantment.damageIncreasedAfterBackstab",
    ...
    Enchantment("enchantment.damageIncreasedAfterBlock",
    ...
    Enchantment("enchantment.damageIncreasedAfterDamageTaken",
    ...
    Enchantment("enchantment.damageIncreasedAfterDodged",
    ...
    Enchantment("enchantment.damageIncreasedAfterFatality",
    ...
    Enchantment("enchantment.damageIncreasedAfterParry",
    ...
    Enchantment("enchantment.damageIncreasedAfterSprint",
    ...
    Enchantment("enchantment.damageIncreasedAfterStagger",
    ...
    Enchantment("enchantment.damageIncreasedAgainstLargeEnemies",
    ...
    Enchantment("enchantment.damageIncreasedAgainstLowHealth",
    ...
    Enchantment("enchantment.damageIncreasedAtFullFocus",
    ...
    Enchantment("enchantment.damageIncreasedAtHighFocus",
    ...
    Enchantment("enchantment.damageIncreasedAtLowHealth",
    ...
    Enchantment("enchantment.damageIncreasedPerNearbyEnemy",
    ...
    Enchantment("enchantment.damageIncreasedWhenNoNearbyEnemy",
    ...
    Enchantment("enchantment.damageScalesWithCurrentFocus",
    ...
    Enchantment("enchantment.damageScalesWithDurability",
    ...
    Enchantment("enchantment.damageScalesWithMissingHealth",
    ...
    Enchantment("enchantment.damageTakenDecreasedAfterBuildupTaken",
    ...
    Enchantment("enchantment.damageTakenDecreasedAtFullStamina",
    ...
    Enchantment("enchantment.damageTakenDecreasedPerNearbyEnemy",
    ...
    Enchantment("enchantment.damageTakenDecreasedWhileBlocking",
    ...
    Enchantment("enchantment.damageTakenDecreasedWhileCharging",
    ...
    Enchantment("enchantment.damageTakenIncreasedAfterConsumeFood",
    ...
    Enchantment("enchantment.damageTakenIncreasedAtLowStamina",
    ...
    Enchantment("enchantment.damageTakenIncreasedIfNotFullFocus",
    ...
    Enchantment("enchantment.damageTakenScalesWithDurability",
    ...
    Enchantment("enchantment.dealDamageOnDamageTaken",
    ...
    Enchantment("enchantment.dealDamageOnDodged",
    ...
    Enchantment("enchantment.dealDamageOnParry",
    ...
    Enchantment("enchantment.dealDamageOnStagger",
    ...
    Enchantment("enchantment.dealElectricDamageOnBlock",
    ...
    Enchantment("enchantment.dealHeatDamageOnBlock",
    ...
    Enchantment("enchantment.dealHeatDamageOnRuneAttack",
    ...
    Enchantment("enchantment.delayedHealing",
      "<b>Food Healing</b> is applied over time",
      List(DelayedHealing)
    ),
    
    Enchantment("enchantment.dodgeStaminaCostDecreasedAtLowHealth",
    ...
    Enchantment("enchantment.dodgeStaminaCostIncreased",
    ...
    Enchantment("enchantment.elementalDamageTakenDecreased",
    ...
    Enchantment("enchantment.endlessClimbing",
      "<b>Endless Climbing</b>",
      List(EndlessClimbing)
    ),
    
    Enchantment("enchantment.enemyArmorDecreasedAfterFrost",
    ...
    Enchantment("enchantment.enemyStaggerResistanceDecreasedAfterInfection",
    ...
    Enchantment("enchantment.equipLoadDecreased",
    ...
    Enchantment("enchantment.equipLoadIncreased",
    ...
    Enchantment("enchantment.executeAgainstInfectedLowHealth",
    ...
    Enchantment("enchantment.experienceGainIncreased",
    ...
    Enchantment("enchantment.fireDamageIncreased",
      "[StatFireDamage] [!sFire]Fire Damage[/s] increased by {0}",
      List(StatModifier(StatType.FireDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.fireResistanceIncreased",
    ...
    Enchantment("enchantment.focusCostDecreased",
    ...
    Enchantment("enchantment.focusCostDecreasedAfterRuneAttack",
    ...
    Enchantment("enchantment.focusCostDecreasedAfterStagger",
    ...
    Enchantment("enchantment.focusCostDecreasedAtLowHealth",
    ...
    Enchantment("enchantment.focusCostIncreased",
    ...
    Enchantment("enchantment.focusCostScalesWithMissingHealth",
    ...
    Enchantment("enchantment.focusGainDecreased",
    ...
    Enchantment("enchantment.focusGainIncreased",
    ...
    Enchantment("enchantment.focusGainScalesWithDurability",
      "[StatFocusGain] <b>Focus Gain</b> increased by up to {0} based on Durability",
      List(StatModifier(StatType.FocusGain, ScalingValue(ValueRange(0, 200, ValueType.Percentage), StatType.Durability), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.gainFocusOnBackstab",
      "Gain {0} [StatFocus] <b>Focus</b> on Backstab",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Backstab)))
    ),
    
    Enchantment("enchantment.gainFocusOnBuildup",
      "Gain {0} [StatFocus] <b>Focus</b> on inflicting Any Status",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageDealt)))
    ),
    
    Enchantment("enchantment.gainFocusOnDodged",
      "Gain {0} [StatFocus] <b>Focus</b> on Damage Dodged",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Dodged)))
    ),
    
    Enchantment("enchantment.gainFocusOnFatality",
      "Gain {0} [StatFocus] <b>Focus</b> on Fatality",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Fatality)))
    ),
    
    Enchantment("enchantment.gainFocusOnKill",
      "Gain {0} [StatFocus] <b>Focus</b> on Kill",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Kill)))
    ),
    
    Enchantment("enchantment.gainFocusOnParry",
      "Gain {0} [StatFocus] <b>Focus</b> on Parry",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Parry)))
    ),
    
    Enchantment("enchantment.gainFocusOnStagger",
      "Gain {0} [StatFocus] <b>Focus</b> on Staggering an Enemy",
      List(ResourceGain(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Stagger)))
    ),
    
    Enchantment("enchantment.gainHealthForFocusSpent",
      "Gain [StatHealth] <b>Health</b> equal to {0} of Focus Spent",
      List(ResourceGain(StatType.Health, ScalingValue(ValueRange(0, 100, ValueType.Percentage), StatType.FocusSpent), ActionCondition(ActionType.FocusUse)))
    ),
    
    Enchantment("enchantment.gainHealthOnBackstab",
      "Gain {0} [StatHealth] <b>Health</b> on Backstab",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Backstab)))
    ),
    
    Enchantment("enchantment.gainHealthOnChargedAttack",
      "Gain {0} [StatHealth] <b>Health</b> on Charged Attack",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.ChargedAttack)))
    ),
    
    Enchantment("enchantment.gainHealthOnDamageDealtAgainstFrozen",
      "Gain {0} [StatHealth] <b>Health</b> on Damage Dealt against [!sIce]Frozen[/s] Enemies",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), AndCondition(ActionCondition(ActionType.DamageDealt), EnemyCondition(EnemyType.Frozen))))
    ),
    
    Enchantment("enchantment.gainHealthOnDamageDealtAtLowHealth",
    ...
    Enchantment("enchantment.gainHealthOnDodged",
      "Gain {0} [StatHealth] <b>Health</b> on Damage Dodged",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Dodged)))
    ),
    
    Enchantment("enchantment.gainHealthOnFatality",
      "Gain {0} [StatHealth] <b>Health</b> on Fatality",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Fatality)))
    ),
    
    Enchantment("enchantment.gainHealthOnKill",
      "Gain {0} [StatHealth] <b>Health</b> on Kill",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Kill)))
    ),
    
    Enchantment("enchantment.gainHealthOnKillAgainstStaggeredEnemies",
    ...
    Enchantment("enchantment.gainHealthOnParry",
      "Gain {0} [StatHealth] <b>Health</b> on Parry",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Parry)))
    ),
    
    Enchantment("enchantment.gainHealthOnStagger",
      "Gain {0} [StatHealth] <b>Health</b> on Staggering an Enemy",
      List(ResourceGain(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Stagger)))
    ),
    
    Enchantment("enchantment.gainHealthOncePerRuneAttack",
    ...
    Enchantment("enchantment.gainStaminaOnBlock",
    ...
    Enchantment("enchantment.gainStaminaOnDamageDealt",
    ...
    Enchantment("enchantment.gainStaminaOnDodged",
      "Gain {0} [StatStamina] <b>Stamina</b> on Damage Dodged",
      List(ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Dodged)))
    ),
    
    Enchantment("enchantment.gainStaminaOnFocusUse",
    ...
    Enchantment("enchantment.gainStaminaOnParry",
      "Gain {0} [StatStamina] <b>Stamina</b> on Parry",
      List(ResourceGain(StatType.Stamina, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.Parry)))
    ),
    
    Enchantment("enchantment.gainStaminaOnStagger",
    ...
    Enchantment("enchantment.healingDecreased",
    ...
    Enchantment("enchantment.healingDecreasedPerNearbyEnemy",
    ...
    Enchantment("enchantment.healingIncreased",
    ...
    Enchantment("enchantment.healingIncreasedAtLowFocus",
    ...
    Enchantment("enchantment.healthRallyIncreased",
    ...
    Enchantment("enchantment.heatDamageIncreasedAfterColdDamageDealt",
    ...
    Enchantment("enchantment.hungerIncreased",
    ...
    Enchantment("enchantment.indestructible",
      "<b>Indestructible</b>",
      List(Indestructible)
    ),
    
    Enchantment("enchantment.infectionBuildupIncreased",
    ...
    Enchantment("enchantment.itemWeightDecreased",
    ...
    Enchantment("enchantment.itemWeightIncreased",
    ...
    Enchantment("enchantment.knockbackResistanceIncreased",
      "<b>Knockback Resistance</b> increased by {0}",
      List(StatModifier(StatType.Armor, ValueRange(0, 100, ValueType.Percentage), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.lifestealDisabled",
      "Cannot [StatLifesteal] <b>Lifesteal</b>",
      List(LifestealDisabled)
    ),
    
    Enchantment("enchantment.lifestealIncreased",
    ...
    Enchantment("enchantment.lifestealIncreasedAtLowHealth",
    ...
    Enchantment("enchantment.lightningDamageIncreased",
    ...
    Enchantment("enchantment.lightningDamageOverride",
      "[StatLightningDamage] [!sLightning]Lightning Damage[/s] Infusion",
      List(ElementalInfusion(ElementType.Lightning))
    ),
    
    Enchantment("enchantment.lightningDamageOverrideAfterSprint",
    ...
    Enchantment("enchantment.lightningResistanceIncreased",
    ...
    Enchantment("enchantment.loseFocusOnDamageTaken",
      "Lose {0} [StatFocus] <b>Focus</b> on Damage Taken",
      List(ResourceLoss(StatType.Focus, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.DamageTaken)))
    ),
    
    Enchantment("enchantment.loseFocusOnFocusUse",
    ...
    Enchantment("enchantment.loseStaminaOnBlock",
    ...
    Enchantment("enchantment.loseStaminaOnDamageTaken",
    ...
    Enchantment("enchantment.maxFocusDecreased",
    ...
    Enchantment("enchantment.maxFocusIncreased",
    ...
    Enchantment("enchantment.maxStaminaDecreased",
    ...
    Enchantment("enchantment.maxStaminaScalesWithMaxFocus",
      "[StatMaxStamina] <b>Max Stamina</b> increased by {0}% of Max Focus",
      List(StatModifier(StatType.MaxStamina, ScalingValue(ValueRange(0, 200, ValueType.Percentage), StatType.MaxFocus), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.movementSpeedDecreased",
    ...
    Enchantment("enchantment.movementSpeedDecreasedPerNearbyEnemy",
    ...
    Enchantment("enchantment.movementSpeedIncreased",
    ...
    Enchantment("enchantment.movementSpeedIncreasedAfterChargedAttack",
    ...
    Enchantment("enchantment.movementSpeedIncreasedAfterKill",
    ...
    Enchantment("enchantment.normalDamageIncreasedAfterChargedAttack",
    ...
    Enchantment("enchantment.onlyHeavyRoll",
      "<b>Heavy Roll</b> only",
      List(OnlyHeavyRoll)
    ),
    
    Enchantment("enchantment.parryDisabled",
      "<b>Parry</b> disabled",
      List(ParryDisabled)
    ),
    
    Enchantment("enchantment.parryStaminaCostDecreased",
      "[StatStaminaCost] <b>Parry Stamina Cost</b> decreased by {0}",
      List(StatModifier(StatType.StaminaCost, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease))
    ),
    
    Enchantment("enchantment.physicalDamageIncreased",
    ...
    Enchantment("enchantment.physicalDamageTakenDecreased",
    ...
    Enchantment("enchantment.poiseDefenseIncreased",
    ...
    Enchantment("enchantment.poiseDefenseIncreasedWhileBlocking",
    ...
    Enchantment("enchantment.poiseDefenseIncreasedWhileCharging",
    ...
    Enchantment("enchantment.refillFocusOnBackstab",
    ...
    Enchantment("enchantment.repairDisabled",
      "<b>Unrepairable</b>",
      List(Unrepairable)
    ),
    
    Enchantment("enchantment.runeDamageIncreased",
      "[StatDamage] <b>Rune Damage</b> increased by {0}",
      List(StatModifier(StatType.Damage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.shockBuildupIncreased",
      "[StatLightningDamage] [!sLightning]Shock Buildup[/s] increased by {0}",
      List(StatModifier(StatType.LightningDamage, ValueRange(0, 200, ValueType.Percentage), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.shockBuildupIncreasedAfterShock",
    ...
    Enchantment("enchantment.speedIncreasedAfterShock",
    ...
    Enchantment("enchantment.staggerDamageIncreasedAfterBackstab",
    ...
    Enchantment("enchantment.staggerDamageIncreasedAfterChargedAttack",
    ...
    Enchantment("enchantment.staggerDamageIncreasedAfterFatality",
    ...
    Enchantment("enchantment.staggerDamageIncreasedAfterKill",
    ...
    Enchantment("enchantment.staggerDamageIncreasedAtLowHealth",
    ...
    Enchantment("enchantment.staggerResistanceDecreased",
    ...
    Enchantment("enchantment.staggerResistanceIncreased",
    ...
    Enchantment("enchantment.staminaCostDecreased",
      "[StatStaminaCost] <b>Stamina Cost</b> decreased by {0}",
      List(StatModifier(StatType.StaminaCost, ValueRange(0, 100, ValueType.Percentage), ModificationType.Decrease))
    ),
    
    Enchantment("enchantment.staminaCostDecreasedAtFullHealth",
    ...
    Enchantment("enchantment.staminaCostDecreasedAtHighFocus",
    ...
    Enchantment("enchantment.staminaCostDecreasedAtLowFocus",
    ...
    Enchantment("enchantment.staminaCostDecreasedAtLowHealth",
    ...
    Enchantment("enchantment.staminaCostIncreased",
    ...
    Enchantment("enchantment.staminaRefillOnParry",
    ...
    Enchantment("enchantment.staminaRefillOnStagger",
    ...
    Enchantment("enchantment.staminaRegenerationIncreased",
    ...
    Enchantment("enchantment.staminaRegenerationScalesWithDurability",
      "[StatStaminaRegen] <b>Stamina Recovery</b> increased by up to {0} based on Durability",
      List(StatModifier(StatType.StaminaRegen, ScalingValue(ValueRange(0, 200, ValueType.Percentage), StatType.Durability), ModificationType.Increase))
    ),
    
    Enchantment("enchantment.swapMaxHealthAndMaxFocus",
      "Swap <b>Max Health</b> and <b>Max Focus</b>",
      List(SwapStats(StatType.Health, StatType.MaxFocus))
    ),
    
    Enchantment("enchantment.takeDamageOnFocusUse",
      "Take {0} [StatPhysicalDamage] [!sPhysical]Damage[/s] on Focus Use",
      List(ResourceLoss(StatType.Health, ValueRange(1, 100, ValueType.Flat), ActionCondition(ActionType.FocusUse)))
    ),
    
    Enchantment("enchantment.unique.buffSpecialDamageAfterSpecial",
    ...
    Enchantment("enchantment.unique.corpseSmearedBlade1",
    ...
    Enchantment("enchantment.unique.corpseSmearedBlade2",
    ...
    Enchantment("enchantment.unique.corpseSmearedBlade3",
    ...
    Enchantment("enchantment.unique.damageAgainstBeasts",
    ...
    Enchantment("enchantment.unique.gainFocusOnDamageTaken",
    ...
    Enchantment("enchantment.unique.glimmeringBulwark0",
    ...
    Enchantment("enchantment.unique.glimmeringBulwark2",
    ...
    Enchantment("enchantment.unique.healthLossOnDamageDealt",
    ...
    Enchantment("enchantment.unique.tarnishedWand1",
    ...
    Enchantment("enchantment.unique.tarnishedWand2",
    ...
    Enchantment("enchantment.unique.theDawnNeverCome2",
    ...
    Enchantment("enchantment.unique.theDawnNeverCome3",
    ...
    Enchantment("enchantment.unique.theDawnNeverComes0",
    ...
    Enchantment("enchantment.unique.weapons.bleedersDelight.chanceStaggerDamageOnDamageDealt",
